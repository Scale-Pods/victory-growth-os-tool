...
export default function SmsDashboardPage() {
    ...
    const donutData = [
        ...
        { name: 'Replies',        value: stats.totalReplies,    color: '#EC4899'  },
    ];
            ...
            <div>
                ...
                <div className="metric-grid">
                    <MetricTile
                        ...
                        icon={<Users size={17} />}
                        onClick={() => router.push('/dashboard/sms/leads')}
                    />
                    <MetricTile
                        ...
                        info="Derived from 'SMS_Replied_track' columns. Select 'Last 3 Months' for full history."
                    />
                    <MetricTile
            ...
            <div>
                ...
                <div className="metric-grid">
                    <MetricTile
                        ...
                        onClick={() => router.push('/dashboard/sms/chat?tab=generated')}
                    />
                    <MetricTile
                    ...
                    <div style={{ height: 200 }}>
                        <ResponsiveContainer width="100%" height="100%">
                            <LineChart data={trendData} margin={{ top: 10, right: 10, left: 0, bottom: 0 }}>
                                ...
                                <Line type="monotone" dataKey="replied" name="Replied" stroke="#EC4899" strokeWidth={2} dot={{ r: 3, fill: '#EC4899', strokeWidth: 0 }} activeDot={{ r: 5 }} />
                            </LineChart>
                        </ResponsiveContainer>
                    </div>
                    {/* Legend */}
                    <div style={{ display: 'flex', justifyContent: 'center', gap: 24, marginTop: 12 }}>
                        {[{ color: 'var(--blue)', label: 'Sent' }, { color: '#EC4899', label: 'Replied' }].map(item => (
