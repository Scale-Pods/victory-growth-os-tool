                ...
                <div style={{ display: 'flex', alignItems: 'center', gap: 8, flexWrap: 'wrap' }}>
                    <div style={{ display: 'flex', background: 'var(--fill-tertiary)', borderRadius: 'var(--radius-md)', padding: 3, gap: 2 }}>
                        ...
                        <button
                            ...
                            style={{ padding: '5px 14px', borderRadius: 'var(--radius-sm)', fontSize: 12, fontWeight: 600, border: 'none', cursor: 'default', display: 'flex', alignItems: 'center', gap: 5, transition: 'all 130ms', background: activeTab === "owners" ? 'var(--bg-layer1)' : 'transparent', color: activeTab === "owners" ? '#EC4899' : 'var(--label-secondary)', boxShadow: activeTab === "owners" ? 'var(--shadow-sm)' : 'none' }}
                    ...
                    {(activeFilters.replyStatus.length > 0 || activeFilters.loops.length > 0 || searchQuery) && (
                        <button onClick={resetFilters} style={{ fontSize: 11, fontWeight: 700, color: '#EC4899', background: 'none', border: 'none', cursor: 'default' }}>RESET FILTERS</button>
                    )}
                ...
                <div style={{ display: 'flex', gap: 6, flexWrap: 'wrap' }}>
                    <DropdownMenu>
                        <DropdownMenuTrigger asChild>
                            <button style={{ display: 'flex', alignItems: 'center', gap: 6, padding: '6px 12px', borderRadius: 'var(--radius-md)', border: '1px solid var(--glass-border)', background: activeFilters.replyStatus.length > 0 ? 'rgba(236,72,153,0.10)' : 'var(--fill-tertiary)', color: activeFilters.replyStatus.length > 0 ? '#EC4899' : 'var(--label-secondary)', fontSize: 13, fontWeight: 500, cursor: 'default' }}>
                    ...
                    {activeTab === "leads" && (
                        <DropdownMenu>
                            <DropdownMenuTrigger asChild>
                                <button style={{ display: 'flex', alignItems: 'center', gap: 6, padding: '6px 12px', borderRadius: 'var(--radius-md)', border: '1px solid var(--glass-border)', background: activeFilters.loops.length > 0 ? 'rgba(236,72,153,0.10)' : 'var(--fill-tertiary)', color: '#EC4899', fontSize: 13, fontWeight: 500, cursor: 'default' }}>
                                ...
                                loading ? (
                                    <tr>
                                        <td colSpan={7} style={{ padding: '80px 16px', textAlign: 'center', color: 'var(--label-tertiary)' }}>
                                            <RefreshCw style={{ width: 20, height: 20, margin: '0 auto 8px', animation: 'spin 1s linear infinite', color: '#EC4899' }} />
                                            Loading SMS leads...
                                        </td>
                                    </tr>
                                        ...
                                        return (
                                            ...
                                            >
                                                ...
                                                <td style={{ padding: '12px 16px' }}>
                                                    <span style={{ display: 'inline-flex', alignItems: 'center', padding: '2px 8px', borderRadius: 'var(--radius-sm)', fontSize: 10, fontWeight: 700, textTransform: 'uppercase', letterSpacing: '0.05em', background: 'rgba(236,72,153,0.10)', color: '#EC4899' }}>
                                                        {lead.source_loop || "—"}
                                                    </span>
                                                </td>
